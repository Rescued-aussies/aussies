...
export const PETS: Pet[] = [
    ...
    //     registered: "AKC Registered", liked: false, status: 'Available', WandH: '20 lbs & 10 Inches',
...

    {
        ...
        registered: "AKC Registered", liked: false, status: 'Available', WandH: '23 lbs & 10 Inches',
        description: "Dieser is a precious little Aussie puppy who is just as cute as can be! This social Aussie-type dog is vet checked and up to date on all shots. He is AKC registered, Potty Trained and comes with a health guarantee provided by the breeder. Dieser is familiar with children and loves to cuddle and play.",
    } as Pet,

    {
        ...
        registered: "AKC Registered", liked: false, status: 'Available', WandH: '20 lbs & 12 Inches',
...

    {
        ...
        registered: "AKC Registered", liked: false, status: 'Available', WandH: '24 lbs & 11 Inches',
        description: "Jake is a calm and cool when it comes to personality, but can also be friendly and loves others around him. This baby is going to make a great puppy and playmate to his family. He likes eating a lot and be sure he's gonna grow fast.",
    } as Pet,
...

    {
        ...
        gender: 'Male', age: "9 Weeks", ageNumber: 9, price: 700, reserve_fee: 250,
        registered: "AKC Registered", liked: false, status: 'Available', WandH: '24 lbs & 12 Inches',
...

    {
        ...
        registered: "AKC Registered", liked: false, status: 'Available', WandH: '21 lbs & 10 Inches',
        description: "Lucy is not the type that can play with anyone, however she is attached and play often with people she knows as well. You can watch your favorite television shows with her as she also like watching the screen. Lucy is lovely and will always be by your side when she is used to you, however she can also be naughty when she does not feel attracted.",
    } as Pet,

    {
        ...
        registered: "AKC Registered", liked: false, status: 'Available', WandH: '22 lbs & 13 Inches',
        description: "Frida is a female Aussie pup that loves cute outings, like going to restaurants or attractive and classic places. Walking is much of her thing when going out. If you are looking for a partner to hang out with, then Frida is your choice. Being a female, she has a strong attraction for Men as compared to Women.",
    } as Pet,

    {
        ...
        registered: "AKC Registered", liked: false, status: 'Available', WandH: '20 lbs & 10 Inches',
        description: "Cookie is a super dark red Aussie. She is used to being around other dogs. We would love to have you come out and see this puppy and its Mama. If you can’t make the drive we can assist you with shipping arrangements. If you would like to hear more about this little puppy give us a call!",
    } as Pet,

    {
        ...
        registered: "AKC Registered", liked: false, status: 'Available', WandH: '23 lbs & 13 Inches',
...

    {
        ...
        registered: "AKC Registered", liked: false, status: 'Available', WandH: '23 lbs & 13 Inches',
        description: "Elsa is a cute little bundle. She has some deep striking colours. She is used to being around small children and has received plenty of attention as she also gives much attention. This little one is current on all shots and would love to pair with someone who knows how to be caring.",
    } as Pet,

    {
        id: 'kai-and-rosa', size: 'Standard', name: 'KAI & ROSA ', image: 'assets/img/aussies/kai-n-rosa.jpg',
        gender: 'Male & Female', age: "6 Months / 5 Months", ageNumber: 9, price: 1500, reserve_fee: 500,
        registered: "AKC Registered", liked: false, status: 'Available', WandH: '30 & 27 lbs / 15 & 14 Inches',
